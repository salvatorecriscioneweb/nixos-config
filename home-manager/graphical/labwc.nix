...
in
{
  ...
  home = {
    file = {
      # LabWC
      ".config/labwc/themerc".source = ../../assets/labwc/themerc;
      ".config/labwc/close.xbm".source = ../../assets/labwc/close.xbm;
      ".config/labwc/themerc-override".source = ../../assets/labwc/themerc-override;
      # Tofi
      ".config/tofi" = {
        source = ../../assets/tofi;
        recursive = true;
  ...
  wayland.windowManager.labwc = {
    ...
    autostart = [
      ...
      "${pkgs.swaybg}/bin/swaybg -i ${bg} &"
      "${pkgs.networkmanagerapplet}/bin/nm-applet &"
      "${pkgs.gammastep}/bin/gammastep -O 5600 2>&1 &"
      "${pkgs.waybar}/bin/waybar >/dev/null 2>&1 &"
      "(sleep 2 && systemctl --user restart emacs) &"
      ...
      keyboard = {
        ...
        keybind = [
          ...
          }
          {
            ...
            action = {
              "@name" = "Execute";
              "@command" = "~/.config/scripts/tofi-power.sh";
            };
          ...
          }
          {
            ...
            action = {
              "@name" = "Execute";
              "@command" = "${pkgs.tofi}/bin/tofi-drun";
            };
          }
        ];
      };
