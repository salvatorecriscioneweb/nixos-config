...
#+begin_src emacs-lisp
(setq doom-font (font-spec :family "RecMonoDuotone Nerd Font" :size 16)
      doom-big-font (font-spec :family "RecMonoLinear Nerd Font" :size 24)
      doom-variable-pitch-font (font-spec :family "Inter" :size 16 :weight 'light)
      doom-emoji-font (font-spec :family "Noto Color Emoji")
      doom-serif-font (font-spec :family "RecMonoLinear Nerd Font" :size 16))
#+end_src
