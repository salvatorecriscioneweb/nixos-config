...
#+begin_src emacs-lisp
(setq doom-font (font-spec :family "CaskaydiaMono Nerd Font" :size 16 :weight 'light)
      doom-big-font (font-spec :family "CaskaydiaMono Nerd Font" :size 24 :weight 'light)
